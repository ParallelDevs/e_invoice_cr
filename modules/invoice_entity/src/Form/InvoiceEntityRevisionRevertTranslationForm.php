...
/**
 * Provides a form for reverting a Invoice revision for a single translation.
 *
 * @ingroup invoice_entity
 */
class InvoiceEntityRevisionRevertTranslationForm extends InvoiceEntityRevisionRevertForm {
  ...
  /**
   * Constructs a new InvoiceEntityRevisionRevertTranslationForm.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $invoice_entity_revision = NULL, $langcode = NULL) {
    ...
    $form = parent::buildForm($form, $form_state, $invoice_entity_revision);
  ...
  protected function prepareRevertedRevision(InvoiceEntityInterface $revision, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\invoice_entity\Entity\InvoiceEntityInterface $default_revision */
    $latest_revision = $this->InvoiceEntityStorage->load($revision->id());
