 ...
 *
 * @see \Drupal\invoice_entity\Entity\InvoiceEntity.
 */
class InvoiceEntityAccessControlHandler extends EntityAccessControlHandler {

  /**
   * {@inheritdoc}
   */
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\invoice_entity\Entity\InvoiceEntityInterface $entity */
    switch ($operation) {
      case 'view':
